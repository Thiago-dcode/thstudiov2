...
export function MediaGalleryCard({ 
    ...
    return (
        <button
            ...
            className="cursor-pointer media-gallery-card group relative w-full overflow-hidden transition-all duration-500 ease-out hover:ring-1 hover:ring-text/20 rounded-xs"
