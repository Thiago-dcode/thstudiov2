...
function ComboboxItem({
 ...
 className={cn(
 "not-data-[variant=destructive]:data-highlighted:**:text-text data-highlighted:bg-fg-2 gap-2 py-1 pr-8 pl-1.5 text-sm [&_svg:not([class*='size-'])]:size-4 relative flex w-full cursor-default items-center outline-hidden select-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
 className
 )}
 {...props}
 >
...
function ComboboxChips({
 ...
 className={cn("dark:bg-fg-2/30 border-fg-2 focus-within:border-accent focus-within:ring-accent/50 has-aria-invalid:ring-error/20 dark:has-aria-invalid:ring-error/40 has-aria-invalid:border-error dark:has-aria-invalid:border-error/50 flex min-h-8 flex-wrap items-center gap-1 border bg-transparent bg-clip-padding px-2.5 py-1 text-sm transition-colors focus-within:ring-[3px] has-aria-invalid:ring-[3px] has-data-[slot=combobox-chip]:px-1", className)}
 {...props}
 />
 )
}
...
function ComboboxChip({
 ...
 className={cn(
 "bg-fg-2 text-text flex h-[calc(--spacing(5.25))] w-fit items-center justify-center gap-1 px-1.5 text-xs font-medium whitespace-nowrap has-data-[slot=combobox-chip-remove]:pr-0 has-disabled:pointer-events-none has-disabled:cursor-not-allowed has-disabled:opacity-50",
 className
 )}
 {...props}
 >
