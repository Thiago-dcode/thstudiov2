...
import { mailingConfig, mailingDriver } from '@repo/backend-lib/config/mailling';
...
import { logConfig } from '@repo/backend-lib/config/logging';
...
import { MailProcessor } from 'src/common/processors/mail.processor';
