...
export const createUserSchema = z.object({
  name: z.string().min(1, "Name is required").max(255, "Name is too long").nullable().optional(),
  surname: z.string().min(1, "Surname is required").max(255, "Surname is too long").nullable().optional(),
  username: z.string().min(3, "Username must be at least 3 characters").max(50, "Username must be at most 50 characters").regex(/^[a-zA-Z0-9]+$/, "Username must be alphanumeric with no spaces"),
  ...
  biography: z.string().max(1000, "Biography is too long").nullable().optional(),
...
export const updateUserSchema = z.object({
  ...
  surname: z.string().min(1, "Surname is required").max(255, "Surname is too long").optional(),
  profession: z.string().max(100, "Profession is too long").optional(),
  ...
  short_biography: z.string().max(120, "Short biography is too long").optional(),
