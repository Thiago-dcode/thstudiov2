...
async function parseResponse<T, K = Record<string, any>>(response: Response): Promise<ActionReturn<T, K>> {
...
export async function createMediaApi(
    ...
    try {
        ...
        return {
            data: null,
            errors: [error instanceof Error ? error.message : "Failed to create media"],
        };
    }
}
...
export async function updateMediaApi(
    ...
    try {
        ...
        return {
            data: null,
            errors: [error instanceof Error ? error.message : "Failed to update media"],
        };
    }
}
...
export async function generateMediaSeoApi(
    ...
    try {
        ...
        return {
            data: null,
            errors: [error instanceof Error ? error.message : "Failed to generate SEO"],
        };
    }
}
