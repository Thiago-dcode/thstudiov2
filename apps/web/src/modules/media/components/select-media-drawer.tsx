...
export const SelectMediaDrawer = ({ userId, mediaSelected, onSelect }: { userId: number, mediaSelected: Record<number, unknown>, onSelect: (media: Media) => void }) => {
    ...
    const mediaSelectedLength = useMemo(() => Object.keys(mediaSelected).length, [mediaSelected]);
    ...
    const handleShapeFilter = useCallback((shape: ShapeFilter) => {
            ...
            <DrawerHeader className="border-b px-4 py-3">
                <div className="flex items-center justify-between gap-3">
                    ...
                    <FileInputProvider allowedMimeTypes={ALLOWED_IMAGE_FILE_TYPES}>
                        <CreateMediaDialog onSuccess={(newMedia) => {
