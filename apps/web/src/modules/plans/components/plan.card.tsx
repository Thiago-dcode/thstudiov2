...
export function PlanCard({ plan, className }: PlanCardProps) {
  ...
  return (
    <div
      ...
      className={cn(
        "relative flex flex-col items-start justify-between gap-8 rounded-md  p-8 transition-all duration-300 bg-fg border hover:border-accent hover:scale-105 shadow-lg max-w-sm  w-full  hover:cursor-pointer",
    ...
    >
      ...
      <div className="w-full">
        <p className="w-full py-3 bg-text rounded-md text-bg text-center font-bold">
