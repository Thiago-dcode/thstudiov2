  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        {images.length === 0 ? (
          <div className="absolute h-[78%] w-[78%] overflow-hidden rounded-md bg-fg-2 shadow-md transition-transform duration-200 group-hover:scale-105">
            ...
            .map((image, revIdx) => {
              ...
              if (i === 0) {
                return (
                  <div
                    key={i}
                    className="absolute z-10 h-[78%] w-[78%] overflow-hidden rounded-md bg-fg-2 shadow-md transition-transform duration-200 group-hover:scale-105"
                  >
                    <Image
                      src={image}
              ...
              return (
                <div
                  key={i}
                  className="absolute h-[78%] w-[78%] overflow-hidden rounded-md bg-fg-2 shadow-sm"
                  style={{
