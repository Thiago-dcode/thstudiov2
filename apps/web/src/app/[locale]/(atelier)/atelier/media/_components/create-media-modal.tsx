...
function MediaUploadContent() {
  ...
  const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (selectedFiles.length > remainingSlots) {
      setError(
        `Maximum ${MAX_FILES} files allowed. You can add ${remainingSlots} more file${remainingSlots === 1 ? "" : "s"}.`,
      );
      e.target.value = "";
      return;
    }
          ...
          <div className="mb-4 space-y-3 p-1 rounded-md border border-border bg-fg-1/50">
            <div className="flex items-center justify-between gap-3">
              <div className="flex-1">
                    ...
                    <InfoTooltip
                      content={
                        <div className="space-y-2">
                          ...
                          <p className="text-sm">
                            Controls the balance between image quality and file
                            size. Lower compression (VERY_LOW, LOW) preserves
                            more detail but creates larger files. Higher
                            compression (HIGH, VERY_HIGH) reduces file size but
                            may slightly reduce image quality.
                          </p>
                          <p className="text-xs text-text-muted">
                            This setting applies to all uploaded files. You can
                            adjust individual files using the sliders below.
                          </p>
                        </div>
                      }
                    />
                ...
                {!allow_media_compression && (
                  <div className="mb-2 p-2 rounded-md bg-amber-500/10 border border-amber-500/20">
                    <p className="text-xs text-amber-600">
                      ...
                      Compression control is not available in your current plan.
                ...
                <Slider
                  defaultValue={[
                    getCompressionLvlIndex(DEFAULT_COMPRESSION_LVL),
                  ]}
            ...
            <div className="pt-2 border-t border-border/50 space-y-2">
                  ...
                  <InfoTooltip
                    content={
                      <div className="space-y-2">
                        ...
                        <p className="text-sm">
                          Automatically generates SEO title, description, alt
                          text, and filename for each image using AI vision
                          analysis.
                        </p>
                        <p className="text-xs text-text-muted">
                          Costs 1 AI credit per image. You have{" "}
              ...
              {!hasCredits && (
                <div className="p-2 rounded-md bg-amber-500/10 border border-amber-500/20">
                  <p className="text-xs text-amber-600">
                    <span className="font-medium">No AI credits:</span> You have
                    used all your AI credits. Upgrade your plan or wait for the
                    next reset.
                  </p>
                </div>
              )}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {mediaPendingToCreate.map((media, index) => {
                ...
                return (
                  ...
                  >
                    <div className="relative aspect-square flex flex-col items-center justify-center overflow-hidden rounded-lg border border-border bg-fg-2 shadow-md min-h-[200px]">
                      <button
                        type="button"
                    ...
                    <div className="flex flex-col gap-2 px-1">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-xs font-semibold text-text bg-fg-1 px-2 py-0.5 rounded-md">
