    ...
    <div className="min-h-screen w-full animate-in fade-in duration-1000">
      ...
      <section className="relative w-full" aria-label="Profile banner">
        ...
        <div className="absolute bottom-0 left-1/2 z-10 -translate-x-1/2 translate-y-1/2">
          <div className="relative size-32 overflow-hidden rounded-full bg-fg-1 shadow-2xl ring-[5px] ring-bg tablet:size-36 laptop:size-40">
            {profile.avatar ? (
              <Image
                src={profile.avatar}
      ...
      <section className="mx-auto flex w-full max-w-2xl flex-col items-center gap-6 px-6 pt-24 pb-12 text-center tablet:pt-28">
        ...
        <div className="flex flex-col items-center justify-center gap-3 pt-4 phone-lg:flex-row">
          <ArtistContactDialog>
            <button
              type="button"
              className="group inline-flex min-h-11 cursor-pointer items-center gap-2.5 rounded-sm bg-text px-7 py-3 text-xs tracking-[0.15em] text-bg uppercase transition-all duration-300 hover:bg-text/90"
            >
              <Mail
          ...
          <Link
            ...
            className="group inline-flex min-h-11 items-center gap-2.5 rounded-sm border border-border/50 px-7 py-3 text-xs tracking-[0.15em] text-text-muted uppercase transition-all duration-300 hover:border-text/30 hover:text-text"
          >
