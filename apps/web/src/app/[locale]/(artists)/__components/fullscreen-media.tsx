  ...
  return (
    ...
    >
      <button
        ...
        className={cn(
          "absolute z-10 cursor-pointer p-2.5 rounded-full transition-all duration-300 focus:outline-none",
          fullscreen
      ...
      {fullscreen && (
        <button
          ...
          className="absolute top-5 right-5 z-10 cursor-pointer p-2.5 rounded-full text-white/60 hover:text-white bg-white/5 hover:bg-white/10 backdrop-blur-sm transition-all duration-300 focus:outline-none"
      ...
      <img
        ...
        className={cn(
          ...
          fullscreen
            ...
            : "max-w-full max-h-[75vh] w-auto h-auto rounded-lg",
        )}
        draggable={false}
      />
