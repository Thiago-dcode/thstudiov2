...
export const metadata: Metadata = {
    ...
    description: "Terms and conditions for using the A11STUDIO portfolio platform.",
}
        ...
        <>
            ...
            <Section title="2. Account Registration">
                ...
                <ul className="list-disc list-inside space-y-2 text-sm leading-relaxed text-text-muted">
                    <li>
                        Your email must be verified before full access is granted.
                    </li>
                    <li>
            ...
            <Section title="5. Acceptable Use">
                ...
                <ul className="list-disc list-inside space-y-2 text-sm leading-relaxed text-text-muted">
                    ...
                    <li>Contains illegal, harmful, threatening, or discriminatory material</li>
            ...
            <Section title="9. Intellectual Property">
                ...
                <P>
                    User-generated content remains the property of its creator as described
                    in Section 4.
                </P>
            </Section>
            ...
            <Section title="13. Governing Law">
                <P>
                    ...
                    shall be resolved in the competent courts of the jurisdiction where
                    A11STUDIO is established.
                </P>
            </Section>
