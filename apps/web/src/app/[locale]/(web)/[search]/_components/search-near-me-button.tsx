  ...
  return (
    <div className="flex flex-col items-center gap-2">
      <button
        ...
        aria-live="polite"
        className={cn(
          "group flex items-center gap-2 border border-border bg-transparent px-4 py-2 text-sm text-text-muted transition-all",
          "hover:border-text/30 hover:text-text",
          "cursor-pointer disabled:cursor-wait disabled:opacity-60",
          isLocated &&
            "border-border-em text-text hover:border-border hover:text-text",
        )}
      >
        {isLocating ? (
