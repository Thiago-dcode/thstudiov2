        ...
        <div className="flex flex-col items-center gap-2">
            <button
                ...
                className={cn(
                    ...
                    isLocated && "border-accent/40 text-accent hover:border-accent/60 hover:text-accent",
                )}
            >
                {isLocating ? (
                    ...
                    <LocateFixed className="size-3.5 shrink-0 transition-transform group-hover:scale-110" aria-hidden />
                )}
            ...
            {geoState === "denied" && (
                <p role="alert" className="flex items-center gap-1.5 text-xs text-text-muted">
