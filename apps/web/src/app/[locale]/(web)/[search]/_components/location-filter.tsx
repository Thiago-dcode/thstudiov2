            ...
            <div className="">
                <Combobox
                    ...
                    onValueChange={(val) => {
                        ...
                        onValueChange(Number.isFinite(id as number) ? (id as number) : undefined)
                    }}
                    items={items}
...
const LocationFilter = () => {
    ...
    const {
        ...
        action: async () =>
            getStatesAction(selectedCountryId ? { country_id: selectedCountryId } : undefined),
    })
        ...
        <div className="flex w-full max-w-full flex-col gap-4">
            ...
            >
                ...
                <LocationEntityCombobox
                    ...
                    disabled={selectedCountryId === undefined || selectedStateId === undefined}
