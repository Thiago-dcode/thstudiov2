...
export const PasswordRecoveryForm = () => {
    ...
    const {isPending, handleSubmit, errors, success,cleanErrors } = useHandleAction({
    ...
    return (
        <FormComponent.Container>
            ...
            <FormComponent.Form onSubmit={handleSubmit} >
                ...
                label="Email address" htmlFor="email" name="email" placeholder="your@email.com" required 
                autoComplete="email"
                autoFocus
