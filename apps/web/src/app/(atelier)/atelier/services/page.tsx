    ...
    return (
        <AdminPageContainer>
            <AdminPageTitle title="Services" info="Services are the offerings you provide to your clients, such as 'Wedding Photography' or 'Web Design'.">
                <CreateResourceButton resource={TABLES_ENUM.SERVICES} href="services/create" label="Create Service" />
            </AdminPageTitle>
            {services.length > 0 ? (
                ...
                >
                    <CreateResourceButton resource={TABLES_ENUM.SERVICES} href="services/create" label="Create Service" variant="outline" />
                </AdminPageEmptyState>
            )}
        </AdminPageContainer>
    );
