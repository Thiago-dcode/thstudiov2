    ...
    return (
        <Web.Container className="">
            <ArtistBreadcrumb
                username={username}
                items={[
                    { url: `/artists/${username}/services`, title: "Services", isActive: false },
                    { url: `/artists/${username}/services/${slug}`, title: service.title, isActive: true },
                ]}
            />
                                    ...
                                    <section className="space-y-5">
                                        ...
                                        <ul className="space-y-3.5">
                                            {service.features.map((feature) => (
                                                <li key={feature.id} className="flex items-start gap-3 text-sm leading-relaxed text-text/80">
                                    ...
                                    <section className="space-y-5">
                                        ...
                                        <ul className="space-y-3.5">
                                            {service.terms.map((term) => (
                                                <li key={term.id} className="flex items-start gap-3 text-sm leading-relaxed text-text-muted">
