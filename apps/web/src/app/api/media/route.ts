...
export async function POST(request: NextRequest) {
    ...
    try {
        ...
        if (rest.description) backendFormData.append("description", rest.description);
        ...
        if (rest.seo_description) backendFormData.append("seo_description", rest.seo_description);
        if (compression_level) backendFormData.append("compression_level", compression_level);
