...
import trustPayment from '@/assets/icons/trust-payment.png'
...
export const PlanProvider = ({ children,availablePaymentMethods }: {
  ...
  const [paymentMethod, setPaymentMethod] = useState<EnumType<'PAYMENT_METHOD'>>(availablePaymentMethods[0].payment_method);
                  ...
                  <div className="flex flex-col gap-4 w-full">
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex flex-col items-end justify-start gap-2">
                        <p className="text-base font-base text-text">€{getMonthlyPrice(priceSelected)?.toFixed(2)}<span className="text-sm text-text-muted">/month</span></p>
                    ...
                    <div className="flex flex-col gap-3 w-full">
                      ...
                      <div className="flex flex-col gap-2">
                        {availablePaymentMethods.map(({payment_method,enabled}) => {
                          ...
                          >
                            ...
                            <Image src={loadPaymentMethodIcon(payment_method)} alt={payment_method} className="w-fit h-6 object-contain" />
                            </div>
...
<Image alt="trust payment" src={trustPayment} height={100} width={300}/>
